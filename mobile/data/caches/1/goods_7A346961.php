<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:74:"C:/phpStudy/PHPTutorial/WWW/xiaomi2016_bak/mobile/themes/miqinew/goods.dwt";i:1;s:85:"C:/phpStudy/PHPTutorial/WWW/xiaomi2016_bak/mobile/themes/miqinew/library/comments.lbi";i:2;s:88:"C:/phpStudy/PHPTutorial/WWW/xiaomi2016_bak/mobile/themes/miqinew/library/page_footer.lbi";}s:7:"expires";i:1541971206;s:8:"maketime";i:1541967606;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>小米电视2 40英寸_小米电视2_购买电视与平板_小米官网——小米手机、红米手机、小米电视官方正品专卖网站 触屏版</title>
...
<header id="header">
  ...
  <h1> 商品详情 </h1>
  <div class="header_r header_search"> <a class="ico_15" href="ectouch.php?act=share&content=小米电视2 40英寸&pic=images/201507/source_img/27_G_1437074702064.jpg"> 分享 </a> </div>
</header>
...
<section class="goods_slider">
  ...
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="images/201507/thumb_img/27_thumb_G_1437074702008.jpg"  alt="小米电视2 40英寸" /></a></div>-->
      <ul>
	  <li><a href="javascript:showPic()"><img alt="" src="http://idashu.cc/images/201507/source_img/27_G_1437074702064.jpg"/></a></li>
         
         
        <li><a href="javascript:showPic()"><img alt="" src="http://idashu.cc/images/201507/thumb_img/27_thumb_P_1437074702931.jpg"/></a></li>
         
        <li><a href="javascript:showPic()"><img alt="" src="http://idashu.cc/images/201507/thumb_img/27_thumb_P_1437074010140.jpg"/></a></li>
         
        <li><a href="javascript:showPic()"><img alt="" src="http://idashu.cc/images/201508/thumb_img/27_thumb_P_1440636386334.jpg"/></a></li>
         
        <li><a href="javascript:showPic()"><img alt="" src="http://idashu.cc/images/201508/thumb_img/27_thumb_P_1440636396876.jpg"/></a></li>
         
        <li><a href="javascript:showPic()"><img alt="" src="http://idashu.cc/images/201508/thumb_img/27_thumb_P_1440636492790.jpg"/></a></li>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(27)" style="display: inline;"></a>
  <div class="title">
    <h1> 小米电视2 40英寸 </h1>
  </div>
    <div class="title">
  ...
  <ul>
        <li>本店售价：<b class="price">2200<em>元</em></b>　    <del>2640<em>元</em></del> 
    </li>
     ...
     <div class="fields"   style="display: block;">	 
        ...
        <ul class="ul2">
          ...
          <h2>尺寸：</h2>
            <div class="items">
                            				  										...
                            				  										<input type="radio" name="spec_10" value="37" id="spec_value_37" checked onclick="changePrice()" />
                    <label for="spec_value_37">45</label> 
          ...
          <h2>颜色：</h2>
            <div class="items">
                            				                                          ...
                            				                                          <input type="radio" name="spec_11" value="38" id="spec_value_38" checked onclick="changePrice()" />
                    <label for="spec_value_38">黄-<font class="price">缺货</font></label> 
                                        <input type="radio" name="spec_11" value="81" id="spec_value_81"  onclick="changePrice()" />
                    <label for="spec_value_81">黑白-<font class="price">缺货</font></label> 
                                        <input type="radio" name="spec_11" value="82" id="spec_value_82"  onclick="changePrice()" />
                    <label for="spec_value_82">红-<font class="price">缺货</font></label> 
                                        <input type="radio" name="spec_11" value="83" id="spec_value_83"  onclick="changePrice()" />
                    <label for="spec_value_83">灰-<font class="price">缺货</font></label> 
        ...
        <ul class="quantity">
          ...
          <div class="items"> <span class="ui-number radius5"> 
            ...
            <input class="num" name="number" id="goods_number" autocomplete="off" value="1" min="1" max="9999" type="number" />
      ...
      <div class="option" > 
        ...
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(27)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(27);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://idashu.cc/images/201507/source_img/27_G_1437074702064.jpg"> </div>
            <div id="right">
              <p>小米电视2 40英寸</p>
...
<section class="s-detail">
  <header>
    <ul style="position: static;" id="detail_nav">
      ...
      <li id="tabs2" onClick="tab(2)" class=""> 评价 <span class="review-count">(6)</span> </li>
...
<p><img src="/xiaomi2015273/images/upload/Image/ger908150140.png" width="1138" height="867" alt="" /></p>	      </div>
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transport.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:27;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
...
var end = "结束";
var goodsId = 27;
var now_time = 1541938806;
var imgUrl = "http://idashu.cc/images/201507/source_img/27_G_1437074702064.jpg"; //缩略图地址
var lineLink = ""; //分享的链接地址
var descContent = "小米电视2 40英寸_小米电视2_购买电视与平板_小米官网——小米手机、红米手机、小米电视官方正品专卖网站"; //摘要信息
var shareTitle = "小米电视2 40英寸_小米电视2_购买电视与平板_小米官网——小米手机、红米手机、小米电视官方正品专卖网站"; //分享的标题
var appid = ""; 
//分享给朋友
