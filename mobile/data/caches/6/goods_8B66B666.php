...
<meta charset="utf-8" />
<title>小米盒子mini版_小米盒子mini_购买电视与平板_小米官网——小米手机、红米手机、小米电视官方正品专卖网站 触屏版</title>
...
<header id="header">
  ...
  <h1> 商品详情 </h1>
  <div class="header_r header_search"> <a class="ico_15" href="ectouch.php?act=share&content=小米盒子mini版&pic=images/201508/source_img/76_G_1440984280163.png"> 分享 </a> </div>
</header>
...
<section class="goods_slider">
  ...
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="images/201508/thumb_img/76_thumb_G_1440984280864.jpg"  alt="小米盒子mini版" /></a></div>-->
      <ul>
	  <li><a href="javascript:showPic()"><img alt="" src="http://idashu.cc/images/201508/source_img/76_G_1440984280163.png"/></a></li>
         
         
        <li><a href="javascript:showPic()"><img alt="" src="http://idashu.cc/images/201508/thumb_img/76_thumb_P_1440984280227.jpg"/></a></li>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(76)" style="display: inline;"></a>
  <div class="title">
    <h1> 小米盒子mini版 </h1>
  </div>
    <div class="title">
  ...
  <ul>
        <li>本店售价：<b class="price">199<em>元</em></b>　    <del>239<em>元</em></del> 
    </li>
    ...
    <form action="javascript:addToCart(76)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
     <div class="fields"   style="display: block;">	 
      ...
      <div class="option" > 
        ...
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(76)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(76);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://idashu.cc/images/201508/source_img/76_G_1440984280163.png"> </div>
            <div id="right">
              <p>小米盒子mini版</p>
...
<section class="s-detail">
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transport.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:76;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
...
var imgUrl = "http://idashu.cc/images/201508/source_img/76_G_1440984280163.png"; //缩略图地址
var lineLink = ""; //分享的链接地址
var descContent = "小米盒子mini版_小米盒子mini_购买电视与平板_小米官网——小米手机、红米手机、小米电视官方正品专卖网站"; //摘要信息
var shareTitle = "小米盒子mini版_小米盒子mini_购买电视与平板_小米官网——小米手机、红米手机、小米电视官方正品专卖网站"; //分享的标题
var appid = ""; 
//分享给朋友
