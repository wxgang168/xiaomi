    ...
    Ajax.call('index.php?is_ajax=1&act=check_order','', function(data){
        ...
        if(total != 0){
			...
			if(new_paid>=0 && new_paid<100){
                $("*[ectype='orderMsg']").append('<p><a href="javascript:void(0);" data-url="order.php?act=list&composite_status=107" data-param="menushopping|02_order_list" target="workspace" target="workspace" class="message">您有新付款的订单</a> <span class="tiptool">（<em id="new_paid">'+new_paid+'</em>）</span></p>')
            }else if(new_paid>99){
				$("*[ectype='orderMsg']").append('<p><a href="javascript:void(0);" data-url="order.php?act=list&composite_status=107" data-param="menushopping|02_order_list" target="workspace" class="message" >您有新订单</a><span class="tiptool">（<em id="new_paid">99+</em>）</span></p>')
			}
